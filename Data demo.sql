...
VALUES (true, 'L2I-2', 'Licence 2 Informatique', 'Maquette L2I - 2ième Année', 'BROUILLON', 1, NOW(), NULL);
...
INSERT INTO ue (active, archive, code, libelle, credits, coefficientue, cm, td, tp, vht, semestre_id, date_creation)
VALUES (true, false, 'INF231', 'Modelisation aléatoire(4)', 6, 3, 36, 18, 18, 120, @id_sem_3, NOW());
SET @id_ue_info231 = LAST_INSERT_ID();
    -- ECs
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2311', 'Probabilité', 18, 18, 0, 24, 60, 1, @id_ue_info231),
           (true, false, 'INF2312', 'Analyse de données', 18, 0, 18, 24, 60, 1, @id_ue_info231);
...
SET @id_ue_info232 = LAST_INSERT_ID();
    -- ECs
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2321', 'Principes des Systèmes d''exploitation', 18, 10, 8, 24, 60, 1, @id_ue_info232),
           (true, false, 'INF2322', 'Introduction aux Réseaux', 18, 10, 8, 24, 60, 1, @id_ue_info232);
...
SET @id_ue_info233 = LAST_INSERT_ID();
    -- ECs
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2331', 'Conception de BD Relationnelles', 18, 18, 12, 32, 80, 1, @id_ue_info233),
           (true, false, 'INF2332', 'Analyse et conception de systèmes', 24, 24, 0, 32, 80, 1, @id_ue_info233);
...
SET @id_ue_info234 = LAST_INSERT_ID();
    -- ECs
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2341', 'Algorithmique & Structures de données', 24, 20, 16, 40, 100, 5, @id_ue_info234),
           (true, false, 'INF2351', 'Développement web Back-end', 18, 8, 10, 24, 60, 3, @id_ue_info234);
...
SET @id_ue_info235 = LAST_INSERT_ID();
    -- ECs
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2352', 'Techniques de communication', 12, 0, 0, 8, 20, 1, @id_ue_info235),
           (true, false, 'INF2342', 'Anglais 3', 12, 0, 0, 8, 20, 1, @id_ue_info235);
...
SET @id_ue_inf241 = LAST_INSERT_ID();
    -- ECS
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2411', 'Développement web front-end', 12, 0, 12, 16, 40, 1, @id_ue_inf241),
           (true, false, 'INF2412', 'Programmation Orientée Objet', 24, 12, 12, 32, 80, 2, @id_ue_inf241);
...
SET @id_ue_inf242 = LAST_INSERT_ID();
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2421', 'Optimisation combinatoire', 24, 0, 12, 24, 60, 1, @id_ue_inf242),
           (true, false, 'INF2422', 'Complexité Algorithmique', 18, 18, 0, 24, 60, 1, @id_ue_inf242);
...
SET @id_ue_inf243 = LAST_INSERT_ID();
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2431', 'Administration Systèmes', 24, 0, 24, 32, 80, 1, @id_ue_inf243),
           (true, false, 'INF2432', 'Administration BD', 24, 0, 24, 32, 80, 1, @id_ue_inf243);

INSERT INTO ue (active, archive, code, libelle, credits, coefficientue, cm, td, tp, vht, semestre_id, date_creation)
VALUES (true, false, 'INF244', 'Réseaux et Services(3)', 6, 3, 44, 12, 16, 120, @id_sem_4, NOW());
SET @id_ue_inf244 = LAST_INSERT_ID();
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2441', 'Services Réseaux', 20, 0, 16, 24, 60, 1, @id_ue_inf244),
           (true, false, 'INF2442', 'Réseaux Locaux', 24, 12, 0, 24, 60, 1, @id_ue_inf244);

INSERT INTO ue (active, archive, code, libelle, credits, coefficientue, cm, td, tp, vht, semestre_id, date_creation)
VALUES (true, false, 'INF245', 'Langues et Humanités 4(5)', 4, 2, 32, 10, 6, 80, @id_sem_4, NOW());
SET @id_ue_inf245 = LAST_INSERT_ID();
    INSERT INTO ec (actif, archive, code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
    VALUES (true, false, 'INF2451', 'Anglais 4', 12, 0, 0, 8, 20, 1, @id_ue_inf245),
           (true, false, 'INF2452', 'Gestion de Projets Informatiques', 20, 10, 6, 24, 60, 3, @id_ue_inf245);
...
-- =======================================================================================
INSERT INTO maquettes (actif, code, description, libelle, statut, version, date_creation, formation_id, maquette_parent_id)
VALUES (true, 'M1-GLRS', 'Master 1 GL et R&S', 'Master 1 Génie Logiciel / R&S', 'BROUILLON', 1, NOW(), NULL);
...
-- 1. Admin BD
INSERT INTO ue (code, libelle, credits, coefficientue, cm, td, tp, vht, semestre_id, active, date_creation)
VALUES ('M1GL01', 'Administration BD (GL)', 2, 2, 10, 0, 10, 20, @id_sem_m1_s2, true, NOW());
SET @id_ue_m1_01 = LAST_INSERT_ID();
    INSERT INTO ec (code, libelle, cm, td, tp, tpe, vht, coefficient, ue_id)
