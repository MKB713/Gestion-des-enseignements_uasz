...
public interface NoteCahierTexteRepository extends JpaRepository<NoteCahierTexte, Long> {
    ...
    // Note: Les requêtes complexes sont simplifiées car Seance et Enseignant sont maintenant des IDs
    // TODO: Implémenter avec Feign clients vers emploi-temps-service et enseignant-service
    ...
    // Note: La méthode findBySemestre est simplifiée car nous n'avons plus de relation directe avec Semestre
    @Query("SELECT n FROM NoteCahierTexte n ORDER BY n.dateCreation DESC")
